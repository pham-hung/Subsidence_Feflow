 ...
 *
 * NOTE! Special notations of function pointers for Python wrapper generation:
 *   (*<name>)(...) generate header and C++ wrapper code 
 *   (* <name>)(...) generate only header code 
 *   ( *<name>)(...) don't generate any code 
 */
struct IfmDocumentMethods
{
  ...
  double (*getMatMassMaxLongDispersivity) (IfmHandle, int);	/* get_mat call */
  double (*getMatMassMaxTransDispersivity) (IfmHandle, int);	/* get_mat call */
  ...
  double (*getMatHeatMaxLongDispersivity) (IfmHandle, int);	/* get_mat call */
  double (*getMatHeatMaxTransDispersivity) (IfmHandle, int);	/* get_mat call */
  ...
  void (*setMatMassMaxLongDispersivity) (IfmHandle, int, double);	/* set_mat call */
  void (*setMatMassMaxTransDispersivity) (IfmHandle, int, double);	/* set_mat call */
  ...
  void (*setMatHeatMaxLongDispersivity) (IfmHandle, int, double);	/* set_mat call */
  void (*setMatHeatMaxTransDispersivity) (IfmHandle, int, double);	/* set_mat call */
  ...
  /* Saving and restoring internal B.C. representation (no Python wrapper) (4.709) */
  ...
  void   ( *interpolateBc) (IfmHandle, IfmBcData* bcOut, const IfmBcData* bcLeft, const IfmBcData* bcRight);
  ...
  double (*getExtentX) (IfmHandle);		/* returns scale_x */
  double (*getExtentY) (IfmHandle);		/* returns scale_y */
  double (*getExtentZ) (IfmHandle);		/* returns 1. ??? */
  double (*getX) (IfmHandle, int);		/* returns x[DIMX][n] */
  double (*getY) (IfmHandle, int);		/* returns x[DIMY][n] */
  double (*getZ) (IfmHandle, int);		/* returns elev[n][...] */
  double (*getXOfObsId) (IfmHandle, int);	/* returns obs x */ 
  double (*getYOfObsId) (IfmHandle, int);	/* returns obs y */ 
  double (*getZOfObsId) (IfmHandle, int);	/* returns obs z */ 
  ...
  int	      (*getNumberOfElementNodes) (IfmDocument pDoc, int nElement);
  int	      (*getNumberOfElementNodes2D) (IfmDocument pDoc, int nElement);

  /* Velocity field precense (v. 6.206) */
  IfmBool     (*isVelocityFieldPresent) (IfmDocument pDoc);

  /* History values (custom Python wrapper) (v. 6.209) */
  IfmResult   ( *getHistoryDimensions)(IfmDocument pDoc, IfmHistoryID nID, int nKind, int* nTimes, int* nCurves);
  IfmResult   ( *getHistoryValues_v1)(IfmDocument pDoc, IfmHistoryID nID, int nKind, int nTimes, int nCurves, double* pTimes, double** pValues);
  ...
  /* Dispersivities (v. 6.258) */
  double      (*getMatMassMinLongDispersivity) (IfmHandle, int);	/* get_mat call */
  double      (*getMatMassMinTransDispersivity) (IfmHandle, int);	/* get_mat call */
  double      (*getMatHeatMinLongDispersivity) (IfmHandle, int);	/* get_mat call */
  double      (*getMatHeatMinTransDispersivity) (IfmHandle, int);	/* get_mat call */
  void	      (*setMatMassMinLongDispersivity) (IfmHandle, int, double);	/* set_mat call */
  void	      (*setMatMassMinTransDispersivity) (IfmHandle, int, double);	/* set_mat call */
  void	      (*setMatHeatMinLongDispersivity) (IfmHandle, int, double);	/* set_mat call */
  void	      (*setMatHeatMinTransDispersivity) (IfmHandle, int, double);	/* set_mat call */
  double      (*getMatMassAnglePitch) (IfmHandle, int);		/* get_mat call */
  double      (*getMatMassAngleYaw) (IfmHandle, int);		/* get_mat call */
  double      (*getMatHeatAnglePitch) (IfmHandle, int);		/* get_mat call */
  double      (*getMatHeatAngleYaw) (IfmHandle, int);		/* get_mat call */
  void	      (*setMatMassAnglePitch) (IfmHandle, int, double);	/* set_mat call */
  void	      (*setMatMassAngleYaw) (IfmHandle, int, double);	/* set_mat call */
  void	      (*setMatHeatAnglePitch) (IfmHandle, int, double);	/* set_mat call */
  void	      (*setMatHeatAngleYaw) (IfmHandle, int, double);	/* set_mat call */

  /* Viscosity dependency (v. 6.265) */
  const char* (*getViscosityDependency)(IfmHandle);
  void	      (*setViscosityDependency)(IfmHandle, const char*);
  ...
  /* History labels (v. 7.007) */
  IfmResult   (*getHistoryValues)(IfmDocument pDoc, IfmHistoryID nID, int nKind, int nTimes, int nCurves, double* pTimes, double** pValues, char** pLabels);

  /* Support of age, exit probablity, and lifetime expectancy (v. 7.009) */
  int	      (*addAgeSpecies) (IfmHandle hdl, const char* pszSpeciesName, IfmSpeciesType nType, int nInheritFrom);
  IfmSpeciesType (*getSpeciesType) (IfmDocument pDoc, int nSpecies);
  void	      (*setSpeciesType) (IfmDocument pDoc, int nSpecies, IfmSpeciesType nType);
  int	      (*findSpecies) (IfmHandle hdl, const char* pszSpeciesName);
  IfmBool     (*powerEnableRecording) (IfmDocument pDoc, int nPOWID, IfmBool bEnable);
  int	      (*powerFindCurve) (IfmDocument pDoc, const char* pszComment);
};
