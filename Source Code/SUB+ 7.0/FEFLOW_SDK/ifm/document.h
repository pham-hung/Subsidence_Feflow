...
#define IFM_CURRENT_DOCUMENT_VERSION 0x7009
#endif
...
#ifdef __cplusplus
  IfmBudgetComponents() { memset(this, 0, sizeof(*this)); }
#endif
} IfmBudgetComponents;
...
typedef struct IfmBudgetComponentsEx {	/* Budget components evaluation structure */
  ...
  double conv_out;		
#ifdef __cplusplus
  IfmBudgetComponentsEx() { memset(this, 0, sizeof(*this)); }
#endif
...
typedef enum _IfmSpeciesType {		/* Species types for multispecies transport */
    IfmSPT_INVALID = -1,		/* Invalid species type */
    IfmSPT_CHEM,			/* Chemical species */
    IfmSPT_AGE,				/* Age species */
    IfmSPT_LTE,				/* Life time expectancy species */
    IfmSPT_EPR				/* Exit probability species */
} IfmSpeciesType;
...
typedef enum _IfmFractureLaw {		/* Fracture element flow law */
  ...
  IfmOVL_LAW	   = 3			/* Diffusive-wave overland flow equation */
} IfmFractureLaw;
...
#ifdef __cplusplus
  _IfmMLWInfo() { memset(this, 0, sizeof(*this)); size = sizeof(*this); }
#endif
} IfmMLWInfo;
...
extern double IfmGetMatMassMaxLongDispersivity (IfmHandle, int);
extern double IfmGetMatMassMaxTransDispersivity (IfmHandle, int);
...
extern double IfmGetMatHeatMaxLongDispersivity (IfmHandle, int);
extern double IfmGetMatHeatMaxTransDispersivity (IfmHandle, int);
...
extern void IfmSetMatMassMaxLongDispersivity (IfmHandle, int, double);
extern void IfmSetMatMassMaxTransDispersivity (IfmHandle, int, double);
...
extern void IfmSetMatHeatMaxLongDispersivity (IfmHandle, int, double);
extern void IfmSetMatHeatMaxTransDispersivity (IfmHandle, int, double);
...
#define IfmGetMatMassLongDispersivity  IfmGetMatMassMaxLongDispersivity
#define IfmGetMatMassTransDispersivity IfmGetMatMassMaxTransDispersivity
#define IfmGetMatHeatLongDispersivity  IfmGetMatHeatMaxLongDispersivity
#define IfmGetMatHeatTransDispersivity IfmGetMatHeatMaxTransDispersivity
#define IfmSetMatMassLongDispersivity  IfmSetMatMassMaxLongDispersivity
#define IfmSetMatMassTransDispersivity IfmSetMatMassMaxTransDispersivity
#define IfmSetMatHeatLongDispersivity  IfmSetMatHeatMaxLongDispersivity
#define IfmSetMatHeatTransDispersivity IfmSetMatHeatMaxTransDispersivity
...
double IfmGetFracElementDiameter (IfmHandle hdl, int nElem);
  ...
  IfmFractureLaw IfmGetFracLaw(IfmHandle hdl, int nFracElement, IfmFractureType FracType, IfmFractureMode FracMode);
  void	  IfmSetFracLaw (IfmHandle hdl, int nFracElement, IfmFractureType FracType, IfmFractureMode FracMode, IfmFractureLaw FracLaw);
  ...
  IfmResult   IfmGetHistoryValues_v1 (IfmDocument pDoc, IfmHistoryID nID, int nKind, int nTimes, int nHist, double* pTimes, double** pValues);
#endif

#if IFM_CURRENT_DOCUMENT_VERSION >= 0x6212
  /* Nodal velocity components */
  IfmBool IfmGetResultsNodalVelocityValuesAtXYZ (IfmHandle, double x, double y, double z, IfmVTriplet* v);
...
#if IFM_CURRENT_DOCUMENT_VERSION >= 0x6258
  extern double IfmGetMatMassMinLongDispersivity (IfmHandle, int);
  extern double IfmGetMatMassMinTransDispersivity (IfmHandle, int);
  extern double IfmGetMatHeatMinLongDispersivity (IfmHandle, int);
  extern double IfmGetMatHeatMinTransDispersivity (IfmHandle, int);
  extern void	IfmSetMatMassMinLongDispersivity (IfmHandle, int, double);
  extern void	IfmSetMatMassMinTransDispersivity (IfmHandle, int, double);
  extern void	IfmSetMatHeatMinLongDispersivity (IfmHandle, int, double);
  extern void	IfmSetMatHeatMinTransDispersivity (IfmHandle, int, double);
  extern double IfmGetMatMassAnglePitch (IfmHandle, int);
  extern double IfmGetMatMassAngleYaw (IfmHandle, int);
  extern double IfmGetMatHeatAnglePitch (IfmHandle, int);
  extern double IfmGetMatHeatAngleYaw (IfmHandle, int);
  extern void	IfmSetMatMassAnglePitch (IfmHandle, int, double);
  extern void	IfmSetMatMassAngleYaw (IfmHandle, int, double);
  extern void	IfmSetMatHeatAnglePitch (IfmHandle, int, double);
  extern void	IfmSetMatHeatAngleYaw (IfmHandle, int, double);
#endif

#if IFM_CURRENT_DOCUMENT_VERSION >= 0x6265
  extern const char* IfmGetViscosityDependency (IfmHandle);
  extern void IfmSetViscosityDependency (IfmHandle, const char* expr);
#endif

#if IFM_CURRENT_DOCUMENT_VERSION >= 0x7001
  extern int	IfmGetMultiLayerWellTopNode (IfmDocument pDoc, int nId);
  extern int	IfmGetMultiLayerWellBottomNode (IfmDocument pDoc, int nId);
#endif

#if IFM_CURRENT_DOCUMENT_VERSION >= 0x7007
  extern IfmResult IfmGetHistoryValues_v2 (IfmDocument pDoc, IfmHistoryID nID, int nKind, int nTimes, int nHist, double* pTimes, double** pValues, char** pLabels);
#endif

#if IFM_CURRENT_DOCUMENT_VERSION >= 0x7009
  extern int		IfmAddAgeSpecies (IfmHandle hdl, const char* pszSpeciesName, IfmSpeciesType nType, int nInheritFrom);
  extern IfmSpeciesType IfmGetSpeciesType (IfmDocument pDoc, int nSpecies);
  extern void	        IfmSetSpeciesType (IfmDocument pDoc, int nSpecies, IfmSpeciesType nType);
  extern int		IfmFindSpecies (IfmHandle hdl, const char* pszSpeciesName);
  extern IfmBool	IfmPowerEnableRecording (IfmDocument pDoc, int nPOWID, IfmBool bEnable);
#endif
...
#if IFM_CURRENT_DOCUMENT_VERSION >= 0x7007
#ifdef __cplusplus
inline IfmResult IfmGetHistoryValues (IfmDocument pDoc, IfmHistoryID nID, int nKind, int nTimes, int nHist, double* pTimes, double** pValues, char** pLabels = 0)
{
  return IfmGetHistoryValues_v2 (pDoc, nID, nKind, nTimes, nHist, pTimes, pValues, pLabels);
}
#else	/* flat C */
#define IfmGetHistoryValues IfmGetHistoryValues_v2
#endif
#else	/* < FEFLOW 7.007 */
#define IfmGetHistoryValues IfmGetHistoryValues_v1
#endif	/* < FEFLOW 7.007 */
